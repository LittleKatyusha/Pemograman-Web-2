...
$siswa1 = new mahasiswa(02011, 'Mochammad Yusuf Habibie', 2015, 'TI', 2.99);
$siswa2 = new mahasiswa(02011, 'Edward Newgate', 2012, 'TI', 3.6);
$siswa3 = new mahasiswa(02011, 'Mulanda Sari', 2013, 'SI', 3.99);
$siswa4 = new mahasiswa(02011, 'John Doe', 2010, 'TI', 4);
$siswa5 = new mahasiswa(02011, 'Mulanda Sari', 2012, 'TI', 4);
