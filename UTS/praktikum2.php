...
<div class="container-fluid">
  <div class="row">
    <div class="col-12">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">List Belanja</h3>
        ...
        <div class="col-8">
          <div class="form-group row">
            <label for="name" class="col-4 col-form-label">Pelanggan</label> 
            <div class="col-8">
              <input id="name" name="name" placeholder="Customer Name" type="text" class="form-control">
            </div>
          </div>
          <div class="form-group row">
            <label class="col-4">Selects products</label> 
            <div class="col-8">
              ...
              <tr>
                ...
                <tbody>
                  <tr>
                    ...
                    <tr>
                      <th scope="row">Fridge 3.500.000</th>
                    </tr> 
                    <tr>
                      <th scope="row">Dish Washer 2.900.000</th>
                    </tr> 
                    </div>
                  </div>
                </form>
