...
class AccountBank extends Account{
    ...
    $customer1 = new AccountBank('C001','Ahmad', 10000000);
    $customer2 = new AccountBank('C002','Budi', 10000000);
    $customer3 = new AccountBank('C003','Kurniawan', 10000000);
